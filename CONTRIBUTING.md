...
Services should use constructor injection via interfaces. Avoid hardcoding `new ServiceClass()` in ViewModels.
...
{
    private readonly TodoStore _store = new();  // Hard dependency
}
...
- [ ] No hardcoded dependencies — use DI where applicable
