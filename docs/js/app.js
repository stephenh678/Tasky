...
import { deduplicateTombstones, mergeRemoteState } from './sync.js?v=4';
import { renderEditableBody } from './editor.js?v=4';
import { icon } from './icons.js?v=4';
import { DEFAULT_DATA_FILE_NAME } from './config.js?v=4';
