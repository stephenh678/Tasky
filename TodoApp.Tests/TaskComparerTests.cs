...
{
    private static TaskItem Make(string text, bool pinned = false, DateTime? due = null, DateTime? created = null, DateTime? modified = null)
    {
        var t = new TaskItem { Text = text, IsPinned = pinned, DueDate = due };
